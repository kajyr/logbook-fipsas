...
const component = (doc, x, y, w, h, dive) =>
    panel(doc, x, y, w, h, PANELS_SPACING, (doc, x, y, w, h) => {
        ...
        const { r, rowH } = rows(
            panelsInnerY + MINI_HEADERS_HEIGHT,
            panelsInnerH - MINI_HEADERS_HEIGHT,
            5,
            0
        );
        ...
        first((doc, x, y, w, h) => {
            ...
            panel(doc, x, y, ripetitivaPanelW, ripetitivaPanelH, 3, (doc, x, y, w, h) => {
                ...
                inputs((doc, x, y, w, h) => {
                    input(doc, x, r[0], w, rowH, null, inputOptions);
                    input(doc, x, r[1], w, rowH, null, inputOptions);
                    input(doc, x, r[2], w, rowH, null, inputOptions);
                    input(doc, x, r[3], w, rowH, null, inputOptions);
                });
            });
        ...
        second((doc, x, y, w, h) => {
            panel(doc, x, y, w, h, 3, (doc, x, y, w, h) => {
                ...
                inputs((doc, x, y, w, h) => {
                    ...
                    input(doc, x, r[2], w, rowH, null, inputOptions);
                    input(doc, x, r[3], w, rowH, null, inputOptions);
                    input(doc, x, r[4], w, rowH, null, inputOptions);
                });
            });
        });
    });
